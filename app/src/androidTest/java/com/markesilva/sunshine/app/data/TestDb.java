...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        long locationRowId = TestUtilities.insertNorthPoleLocationValues(getContext());
        ...
        // query if you like)
        TestUtilities.validateCursor("Test location", c, testValues);
    ...
    public void testWeatherTable() {
        ...
        assertTrue("Error: Couldn't insert weather data into db", weatherRowId != -1);
        ...
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCursor("Test weather", c, testValues);
