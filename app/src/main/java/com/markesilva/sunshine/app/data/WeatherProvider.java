 ...
 */
package com.markesilva.sunshine.app.data;
...
public class WeatherProvider extends ContentProvider {
    ...
    static UriMatcher buildUriMatcher() {
        ...
        m.addURI(authority, WeatherContract.PATH_LOCATION, LOCATION);
        m.addURI(authority, WeatherContract.PATH_WEATHER, WEATHER);
        m.addURI(authority, WeatherContract.PATH_WEATHER + "/*", WEATHER_WITH_LOCATION);
        m.addURI(authority, WeatherContract.PATH_WEATHER + "/*/#", WEATHER_WITH_LOCATION_AND_DATE);
